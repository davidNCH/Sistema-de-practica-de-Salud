...
Public Class libro_donado
    ...
    End Sub
    Private Sub libro_donado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnmostrartodo_Click(sender As Object, e As EventArgs) Handles btnmostrartodo.Click
        Dim oclientes As New SqlDataAdapter("SELECT id_libro, titulo,genero,autor,nro_paginas,estado,año_d_edicion,editorial,modo_adquisicion,fecha_adquisicion,disponible from libros where modo_adquisicion='Donado'", cn)
    ...
    Private Sub Print_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles Print.PrintPage
        ...
        For i = 0 To dvw.Count - 1 ' devuelve cantdd de regstr de tblas
            ...
            stb.Append(dvw(i)(1).ToString.PadRight(35)) 'anexar de derecha a izquierda
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        Dim Cmd As New SqlCommand("select getdate()", cn)
        adaptador = New SqlDataAdapter("SELECT id_libro, titulo,genero,autor,nro_paginas,estado,año_d_edicion,editorial,modo_adquisicion,fecha_adquisicion,disponible from libros where modo_adquisicion='Donado'", cn)
        Dim oCommBuild As SqlCommandBuilder = New SqlCommandBuilder(adaptador)
        data = New DataSet()
        cn.Open()
        adaptador.Fill(data, "LIBROS")
